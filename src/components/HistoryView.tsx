...
export default function HistoryView() {
  const milestones = [
    { year: '1953', title: 'البداية الأولى', desc: 'وضع أبونا مرقس داود حجر أساس الكنيسة (مبنى مؤقت).' },
    { year: '1960', title: 'تشييد المبنى الحالي', desc: 'بدأ تشييد المبنى الحالي وأنشأتها جمعية أصدقاء الكتاب المقدس.' },
      ...
      <section className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <div className="space-y-4 arabic-sans text-stone-600 leading-relaxed text-lg">
            <p>
              بدأ تاريخ كنيستنا في عام ١٩٥٣ م عندما وضع أبونا المحبوب مرقس داود حجر الأساس للمبنى الأول (المؤقت)، لتكون منارة روحية في المنطقة.
            </p>
            <p>
              وفي عام ١٩٦٠ م، بدأ تشييد المبنى المهيب الحالي تحت رعاية وإشراف "جمعية أصدقاء الكتاب المقدس"، التي حملت على عاتقها مسؤولية تأسيس هذا الصرح الروحي ليكون مكاناً للصلاة وبيت الصداقة والمحبة لكل المؤمنين.
            </p>
          </div>
        </div>
