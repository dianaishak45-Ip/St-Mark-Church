    ...
    <div className="max-w-5xl mx-auto space-y-12 pb-24 lg:pb-0">
      ...
      <div className="grid lg:grid-cols-3 gap-8 text-right" dir="rtl">
        <div className="lg:col-span-2 space-y-8">
          <section className="bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-sm border border-stone-100 space-y-8">
            ...
            <div className="space-y-8 arabic-serif text-stone-800 leading-[2.2] text-2xl">
              <div className="p-8 lg:p-10 bg-stone-50 rounded-[2.5rem] border-r-8 border-amber-600">
          ...
          <div className="grid md:grid-cols-1 gap-8">
            {data.readings.map((reading, i) => (
              <motion.div 
                ...
                className="bg-white p-8 lg:p-10 rounded-[2.5rem] border border-stone-100 shadow-sm space-y-6"
              >
                <div className="flex justify-between items-start">
                  <h3 className="arabic-serif text-3xl font-bold text-amber-800 leading-normal">{reading.title}</h3>
        ...
        <div className="space-y-8">
          <div className="bg-amber-700 rounded-[2.5rem] p-8 lg:p-10 text-white space-y-6">
          ...
          <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-stone-100 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-stone-50 p-6 rounded-[1.5rem]">
                <span className="arabic-sans text-stone-500">اليوم القبطي</span>
                <span className="arabic-serif font-bold text-amber-700 text-2xl">{data.copticDate}</span>
              </div>
